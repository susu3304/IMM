...
7. `v*` tag push で統合repo rootの `Release IMM` workflow が Release を作る。
   成果物は MSI、Windows portable zip、winget manifests、deb、macOS tarball、VSIX。
...
## Install
- Windows MSI: imm-windows-x64.msi
